...
//     try {
//       // TODO: Pass timeframe to your API if supported
//       // Example: await ApiService.getCandles(widget.symbol, timeframe: timeframe);
...
//     for (var log in tradeLogs) {
//       final type = log["type"];
//       final priceRaw = log["price"];
//       if (priceRaw == null || priceRaw is! num) continue;

//       final price = priceRaw.toDouble();
//       if (price <= 0 || price.isNaN || price.isInfinite) continue;

//       final x = (candles.length - 1)
//           .toDouble(); // improve with timestamp match if possible
...
//                         loadChart(); // reload data for new timeframe
//                       },
//                       child: Text(
//                         tf.toUpperCase(),
//                         style: TextStyle(
...
//                 // Main Price Chart with Tooltip + Scatter
//                 Expanded(
//                   flex: 3,
//                   child: Stack(
//                     children: [
...
//                               ),
//                           ],
//                           // ──→ Interactive tooltip showing PRICE only
